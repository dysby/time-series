...
y <- qualityAR03 %>% filter(Location=="Laranjeiro-Almada")
...
saveRDS(fit, file = "models/laranjeiro_fit_s012.rds")
# Load the city object as city
fit <- readRDS("models/laranjeiro_fit_s012.rds")
