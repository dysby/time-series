...
fit <- y %>%
  model(
    sarima000012 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(1, 0, 1) + PDQ(1, 0, 1, period=24)),
  )
...
fit <- y %>%
  model(
    sarima100012 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(0, 0, 0) + PDQ(0, 1, 2, period=24)),
  )
p1 <- fit %>% augment() %>% ACF(.innov, lag_max = 150) %>% autoplot() +
  ggtitle(paste(fit$Location, format(fit %>% pull(2)))) + ylim(-0.1,0.5)
p2 <- fit %>% augment() %>% PACF(.innov, lag_max = 150) %>% autoplot() + ylim(-0.1,0.5)
...
fit <- y %>%
  model(
    sarima000011 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(2, 0, 0) + PDQ(1, 1, 1, period=24)),
  )
p1 <- fit %>% augment() %>% ACF(.innov, lag_max = 150) %>% autoplot() +
  ggtitle(paste(fit$Location, format(fit %>% pull(2)))) + ylim(-0.1,0.5)
p2 <- fit %>% augment() %>% PACF(.innov, lag_max = 150) %>% autoplot() + ylim(-0.1,0.5)
...
fit <- y %>%
  model(
    sarima000011 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(1, 0, 0) + PDQ(2, 0, 0, period=24)),
  )
p1 <- fit %>% augment() %>% ACF(.innov, lag_max = 150) %>% autoplot() +
  ggtitle(paste(fit$Location, format(fit %>% pull(2)))) +
  ylim(-0.1,0.5)
p2 <- fit %>% augment() %>% PACF(.innov, lag_max = 150) %>% autoplot() + ylim(-0.1,0.5)
p1 + p2
...
fit <- y %>%
  model(
    sarima101101 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(1, 0, 1) + PDQ(1, 0, 1, period=24)),
    sarima201101 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(2, 0, 1) + PDQ(1, 0, 1, period=24)),
    sarima102101 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(1, 0, 2) + PDQ(1, 0, 1, period=24)),
    sarima101111 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(1, 0, 1) + PDQ(1, 1, 1, period=24)),
    sarima200111 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(2, 0, 0) + PDQ(1, 1, 1, period=24)),
    sarima201111 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(2, 0, 1) + PDQ(1, 1, 1, period=24)),
    sarima102111 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(1, 0, 2) + PDQ(1, 1, 1, period=24)),
    sarima301111 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(3, 0, 1) + PDQ(1, 1, 1, period=24)),
    sarima103111 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(1, 0, 3) + PDQ(1, 1, 1, period=24)),
...
fit <- y %>%
  model(
    sarima101111 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(1, 0, 1) + PDQ(0, 1, 1, period=24)),
    sarima200111 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(2, 0, 0) + PDQ(0, 1, 1, period=24)),
    sarima201111 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(2, 0, 1) + PDQ(0, 1, 1, period=24)),
    sarima301111 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(3, 0, 1) + PDQ(0, 1, 1, period=24)),
    sarima101012 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(2, 0, 0) + PDQ(0, 1, 2, period=24)),
    sarima200012 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(2, 0, 0) + PDQ(0, 1, 2, period=24)),
    sarima201012 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(2, 0, 1) + PDQ(0, 1, 2, period=24)),
    sarima202012 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(2, 0, 2) + PDQ(0, 1, 2, period=24)),
    sarima301012 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(3, 0, 1) + PDQ(0, 1, 2, period=24)),
...
fits <- fits %>% rename(sarima101011 = sarima101101,
                       sarima200011 = sarima200101,
                       sarima201011 = sarima201101,
                       sarima301011 = sarima301101)

fit <- fits %>% select(Location, sarima301012)
fit_diag_plots(fit)
...
# a <- y %>%
#   model(
#     # The acf of s100 have non stationary seasonal peacks, that do not
#     sarima200100 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(2, 0, 0) + PDQ(1, 0, 0, period=24)),
#     sarima101200 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(1, 0, 1) + PDQ(2, 0, 0, period=24)),
#     sarima101012 = ARIMA(box_cox(Ozone, lambda) ~ 0 + pdq(1, 0, 1) + PDQ(0, 1, 2, period=24)),
#   )
# c <- cbind(fit, a$sarima101012) %>% rename(sarima101012 = "a$sarima101012")
# fit <- mable(c, key = Location, model = c(-1))

# 101012 parece melhor que o 201012
...
saveRDS(fits, file = "models/restelo_fit_s011.rds")
# Load the city object as city
fit <- readRDS("models/restelo_fit_s012.rds")
