...
fit <- y %>%
  model(
    ...
    # sarima200210 = ARIMA(box_cosx(Ozone, lambda) ~ 0 + pdq(2,0,0) + PDQ(2, 1, 0, period=24)),
...
saveRDS(fit, file = "models/estarreja_fit_s012.rds")
# Load the city object as city
fit <- readRDS("models/estarreja_fit_s012.rds")

best_model_name = "sarima200012"
